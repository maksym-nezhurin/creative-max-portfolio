...
console.log(viewMoreText)
	...
	return (
		<div ref={component}>
			...
			{/* { Hover Element } */}
			<div className="hover-reveal pointer-events-none absolute left-0 top-0 -z-10 h-[320px] w-[220px] rounded-lg bg-over bg-center opacity-0 translate-[background] duration-300 "
				ref={revealRef}
